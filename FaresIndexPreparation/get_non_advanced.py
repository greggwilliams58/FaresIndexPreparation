...
def get_non_advanced_data(df,destinationpath,RDGfarespath,LENNONfarespath):
    ...
    df.rename(columns={'RDG_FARES_2019':'FARES_2019','RDG_FARES_2020':'FARES_2020','Adjusted Earnings Amount':'Weightings'},inplace=True)
    ...
    populated2019and2020 = percentagechange(populated2019and2020,'FARES_2020','FARES_2019')
